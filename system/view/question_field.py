...
class QuestionField:
    ...
    def __init__(self, master, kb_class, main_app):
        ...
        self.add_question_field(self.scrollable_frame)
        ...
        self.add_save_button(self.scrollable_frame)
    ...
    def add_input_field(self):
        ...
        if self.question[1] == QuestionType.SELECT:
            ...
            self.input_field = RadioButtonField(self.scrollable_frame, self.question[2])
        ...
        # elif 'subject' in self.question:
            ...
            self.input_field = CheckButtonField(self.scrollable_frame, self.question[2])

        else:  # if self.question[1] == QuestionType.TEXT_FIELD:
            self.input_field = TextFields(self.scrollable_frame)
